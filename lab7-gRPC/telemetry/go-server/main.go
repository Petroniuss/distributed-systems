...
func handleBatch(data *pb.BatchedData) error {
	...
	fmt.Printf("\t Start Time: %v", data.BatchStart)
	fmt.Printf("\t End Time: %v", data.BatchEnd)
...
func logTemperatureMeasurement(measurement *pb.Measurement) {
	...
	fmt.Printf("\t Temperature: %v, Timestamp: %v", temperature, timestamp)
}
...
func logPowerMeasurement(measurement *pb.Measurement) {
	...
	fmt.Printf("\t Power: %v, Timestamp: %v", power, timestamp)
}
...
func logWaterMeasurement(measurement *pb.Measurement) {
	...
	fmt.Printf("\t Water: %v, Timestamp: %v", water, timestamp)
}
